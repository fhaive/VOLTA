...
with open("edges_jaccard_distance.pckl", "wb") as f:
    pickle.dump(jd, f, protocol=4)
with open("edges_percentage_similarity.pckl", "wb") as f:
...
a,b, x = node_edge_similarities.build_similarity_matrix_for_binary_and_ranked(sorted_networks, compute="kendall", kendall_usage="top", kendall_x = 50)

with open("edges_kendall_top_50.pckl", "wb") as f:
...
with open("edges_hamming.pckl", "wb") as f:
    pickle.dump(a, f, protocol=4)
...
jd = node_edge_similarities.to_distance(j)
#save pickles and plot
with open("nodes_jaccard_distance.pckl", "wb") as f:
    pickle.dump(jd, f, protocol=4)
with open("nodes_percentage_similarity.pckl", "wb") as f:
    pickle.dump(s, f, protocol=4)
...
for key in options_keys:
    ...
    with open("nodes_kendall_top_50_"+key+".pckl", "wb") as f:
        pickle.dump(a, f, protocol=4)
...
with open("nodes_hamming.pckl", "wb") as f:
    pickle.dump(a, f, protocol=4)
