...
#save consensus
with open("results_complete/temp_performed_walks.pckl", "wb") as f:
...
#save consensus
with open("results_complete/walks_sim_edges.pckl", "wb") as f:
    pickle.dump(results_edges, f, protocol=4)

with open("results_complete/walks_sim_nodes.pckl", "wb") as f:
