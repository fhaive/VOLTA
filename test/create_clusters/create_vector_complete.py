...
def graphlet_helper(network, estimate_on=1, edge_attribute="weight", motif_min_size=2, motif_max_size=4):
...
#save
with open("results_complete/feature_vector.pckl", "wb") as f:
