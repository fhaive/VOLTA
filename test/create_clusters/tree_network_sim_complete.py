...
with open("results_complete/tree_vector.pckl", "wb") as f:
...
with open("results_complete/tree_percentage.pckl", "wb") as f:
    pickle.dump(results_percentage, f, protocol=4)


with open("results_complete/tree_smc.pckl", "wb") as f:
    pickle.dump(results_smc, f, protocol=4)

with open("results_complete/tree_correlation.pckl", "wb") as f:
    pickle.dump(results_correlation, f, protocol=4)

with open("results_complete/tree_jaccard.pckl", "wb") as f:
